        ...
        <div class="card" style="background-color:white">
            <div class="d-flex justify-content-between">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active"  data-toggle="tab" href="#registration_details" role="tab">
                            <span class="hidden-sm-up"></span>
                            <span class="hidden-xs-down">Registration Details</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#agreement_details" role="tab">
                            <span class="hidden-sm-up"></span>
                            <span class="hidden-xs-down">Agreement Details</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"   data-toggle="tab" href="#report_layout" role="tab">
                            <span class="hidden-sm-up"></span>
                            <span class="hidden-xs-down">Report Layout</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#payment_details" role="tab">
                            <span class="hidden-sm-up"></span>
                            <span class="hidden-xs-down">Payments Details</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#completed_details" role="tab">
                            <span class="hidden-sm-up"></span>
            ...
            <div class="tab-content tabcontent-border">
                <div class="tab-pane active"  id="registration_details" role="tabpanel">
                    <div>
                        <div class="card-body">
                ...
                <div class="tab-pane"   id="agreement_details" role="tabpanel">
                ...
                <div class="tab-pane  p-20" id="report_layout" role="tabpanel">
                    <div>
                                ...
                                <tr style="color:black;">
                                    ...
                                    <td class="text-center">
                                        @if($report->layout_type == 2)
                                         <a  href="{{route('report', ['id' => $report->id ,'layout_status' => $report->layout_status , 'layout_type' => 1 ] )}}"><button class="btn btn-primary btn-sm">Default Layout</button></a>
                                        @else
                                        <a  href="{{route('report', ['id' => $report->id ,'layout_status' => $report->layout_status , 'layout_type' => 2 ] )}}"><button class="btn btn-primary btn-sm">Custom Layout</button></a>
                ...
                <div class="tab-pane  p-20" id="payment_details" role="tabpanel">
                    <div class="p-20">
